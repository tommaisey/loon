...
-----------------------------------------------------------------------------
test('terminal - one passing test with no message', function()
    loon.add('jabberwock', function()
        eq(42, 42)
    end)
end)

test('terminal - one passing test with a message', function()
    loon.add('jabberwock', function()
        eq(42, 42, 'here is the message')
    end)
end)

test('terminal - one failing test with no message', function()
    loon.add('jabberwock', function()
        eq(42, 99)
    end)
end)

test('terminal - one failing test with a message', function()
    loon.add('jabberwock', function()
...
test('terminal - two passing tests', function()
    loon.add('jabberwock', function()
        eq(1, 1)
    end)
...
test('terminal - one failing test among passes', function()
    loon.add('jabberwock', function()
        eq(1, 1)
    end)
    loon.add('brillig', function()
...
test('terminal - terse option with all pass', function()
    loon.add('jabberwock', function()
        eq(1, 1)
    end)
    loon.add('mimsy', function()
...
test('terminal - terse option with failure', function()
    loon.add('jabberwock', function()
        eq(1, 1)
    end)
    loon.add('slithy', function()
...
test('terminal - uncolored option', function()
    loon.add('jabberwock', function()
        eq(1, 1)
    end)
    loon.add('slithy', function()
...
-----------------------------------------------------------------------------
test('terminal - only top-level suites', function()
...
test('terminal - nested suites', function()
    loon.suite.start('suite 1')
...
test('terminal - mixed default and suites (1)', function()
    loon.add('jabberwock', function()
        eq(1, 1)
    end)
    loon.suite.start('suite 1')
...
test('terminal - mixed default and suites (2)', function()
    loon.suite.start('suite 1')
    loon.add('jabberwock', function()
        eq(1, 1)
    end)
...
test('terminal - suite.with', function()
