...
-----------------------------------------------------------------------------
test.add('xml escaping', function()
    snap.output('special chars in suite, test, and failure', function()
        loon.suite.add('a & b <suite>', function()
            loon.add('quoted "name" with \'apostrophe\'', function()
                eq('a < b', 'a > b', 'msg with "quotes" & <tags>')
            end)
            loon.add('errors with markup', function()
                error('boom: <fatal> & "stuck"')
            end)
        end)
